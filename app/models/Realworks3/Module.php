...
{
    const MIN_RW_VERSION = '3.4';
    const MAX_RW_VERSION = '4';
    ...
    public function isActive()
    {
        ...
        return version_compare($pluginData['Version'], self::MAX_RW_VERSION, '<')
            && version_compare($pluginData['Version'], self::MIN_RW_VERSION, '>=');
    }
